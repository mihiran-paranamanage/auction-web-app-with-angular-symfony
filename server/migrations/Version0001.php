...
final class Version0001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_role_id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D6498E0E3CA6 (user_role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_bid_config (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, max_bid_amount NUMERIC(10, 2) DEFAULT \'0\' NOT NULL, is_auto_bid_enabled TINYINT(1) DEFAULT \'0\' NOT NULL, current_bid_amount NUMERIC(10, 2) DEFAULT \'0\' NOT NULL, notify_percentage INT DEFAULT 100 NOT NULL, INDEX IDX_854BF4E8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
